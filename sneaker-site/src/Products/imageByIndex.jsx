...
export const sneakerArray = [
  ...
  },
  {
    ...
    src: image2,
    description: "Unveiling the epitome of timeless design with the Jordan 1 Retro High OG Satin Bred in the ever-classic Black/University Red/White colorway. The sophisticated satin finish adorns the iconic silhouette, exuding a blend of vintage charm and modern-day chic.",
    price: "$180"
  },
  {
    title:"Jordan 4 Thunder",
    src: image3,
    description: "Jordan Brand brought back this fan favorite colorway that is constructed using premium black nubuck uppers with splashes of Tour Yellow throughout the midsole, lace eyelets, and tongue. Michael Jordan's iconic Jumpman logo is placed on the heel tab, tongue and insoles of the sneakers.",
    price: "$210"
  },
  {
