...
import image5 from "../../assets/NikeDunkSB.png"
...
export const products = [
  ...
  {
    name: 'Nike Dunk "Purple Pigeon"',
    src: image4,
    description:
      "The Nike SB Dunk Low Pro SB ‘Purple Pigeon’ was released In 2006 and has a close resemblance to the ‘Pigeon’ Dunk since they share a grey base color. The ‘Purple Pigeon’ showcases a Light Graphite upper with a Violet Swoosh and outsole.",
    price: "$500",
    sizes: [7, 8.5, 9, 11, 12, 13],
  },
  {
